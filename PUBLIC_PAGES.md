...
Zakresy świata, Europy, Polski i Turcji używają kodów krajów podanych w rekordach. Europa to jawna lista w `web/lib/situation.ts`, z Cyprem i Kosowem, bez Rosji i Turcji; nie jest geometrycznym kontynentem. Rekordów bez kraju oraz globalnych komunikatów usług nie przypisujemy automatycznie do wybranego regionu. Skróty kamery na samej mapie przesuwają widok, ale nie zmieniają filtrów danych.
